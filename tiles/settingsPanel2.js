import { S as SETTINGS } from "./tiles.js"
...
export function createSlider(variable, title, min, max, step, divider, tooltip) {
...
const selectors = {}
export function createSelector(variable, title, options, divider, tooltip) {
    const mainPanel = document.getElementById("settingsPanel");
