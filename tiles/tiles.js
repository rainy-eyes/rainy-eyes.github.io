...
function setStartingColors() {
    ...
    else if (S.hueMode.v === "random") {
        h = randomArrayItem(S.startHue.possibilities);}

    if (S.satMode.v === "constant") {s = S.startSat.v;}
    else if (S.satMode.v === "perlinNoise") {s = S.startSat.v;}
    else if (S.satMode.v === "random") {
        s = randomArrayItem(S.startSat.possibilities);}

    if (S.lightMode.v === "constant") {l = S.startLight.v;}
    else if (S.lightMode.v === "perlinNoise") {l = S.startLight.v;}
    else if (S.lightMode.v === "random") {
        l = randomArrayItem(S.startLight.possibilities);}
